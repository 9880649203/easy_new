...
export class UsersPage implements OnInit {
  ...
  constructor(private modalCtrl: ModalController, private rest: RestService,
    ...
    this.gridOptions.columnDefs = [
      {
        ...
        // valueFormatter: this.subAgencyEditToggle,
    ...
    // this.config._setTab$.subscribe(data => {
    //   this.setTab(0)
    // })
  ...
  */
  ...
  // subAgencyEditToggle(event) {
  //   alert()
  //   if (event.data.parentAgency_name == "Easy Krishi") {
  //     this.roleService.editSubAgency = true;
  //   }
  //   else {
  //     this.roleService.editSubAgency = false;
  //   }
  //   console.log("parent data", this.roleService.editSubAgency)
  //   // return this.roleService.editSubAgency
  // }
