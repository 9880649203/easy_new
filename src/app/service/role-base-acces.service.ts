...
export class RoleBaseAccesService {
  ...
  public _viewMenu$: BehaviorSubject<any> = new BehaviorSubject<any>([]);
  public _viewMenu = this._viewMenu$.asObservable();
  ...
  determineRoleBasedAccess() {
    console.log("roles", this.role_list)
