...
export class DashboardPage {
  ...
  public chartLabels1: Label[] = ['Karnatka', 'Delhi', 'Lucknow', 'Allahabad', 'Patna'];
  public chartData1: SingleDataSet = [10, 2, 90, 30, 80]
  ...
  constructor(private chartService: DashboardService, private config: ConfigService,private location: LocationStrategy) {
